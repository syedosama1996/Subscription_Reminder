-- ============================================
-- STEP 2: Add Missing Columns and Fix Numeric Precision
-- Run this AFTER fixing the status constraint
-- ============================================
...
BEGIN
  ...
  IF EXISTS (SELECT 1 FROM information_schema.columns 
             WHERE table_name = 'invoices' AND column_name = 'duration') THEN
...
-- Verification query (optional - run this to check everything worked)
SELECT 
  column_name, 
  data_type, 
  numeric_precision, 
